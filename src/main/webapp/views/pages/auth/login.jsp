...
<c:if test="${not empty erro}">
    <div class="alert alert-danger" role="alert">
        ...
        <div class="text-center mt-3">
            <a href="${pageContext.request.contextPath}/createAccount" class="text-decoration-none">Criar uma nova conta</a>
        </div>

        <div class="text-center mt-3">
            <a href="${pageContext.request.contextPath}/forgotPassword" class="text-decoration-none">Esqueceu a senha?</a>
        </div>
